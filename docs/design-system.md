...
- Full rework v4 shell: prefer the floating `.ember-dock` over the old desktop sidebar. The app should read as a mobile-first planner expanded to desktop, with one strong atmosphere surface and quieter supporting panels.
